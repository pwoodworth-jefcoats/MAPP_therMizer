---
title: "MAPP_run_Mizer_ResourceCalibration"
...
This script runs _mizer_ with the built-in semi-chemostat resource for use in calibrating the
plankton spectrum that's informed by the LENS output.  
...
projection_steady_F <- project(params_steady_F, dt = 1/12, t_max = 600, t_save = 1/12, effort = 0.2)
